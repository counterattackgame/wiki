...
[Read this page in 🇪🇸 Espanol](https://counterattackgame.github.io/wiki/es/shooting)
...
3. In the event of a tie, follow the [Loose Ball](https://counterattackgame.github.io/wiki/es/loose_ball) instructions.
...
- During the attacking team's player movements in a [Movement Phase](https://counterattackgame.github.io/wiki/es/movement_phase) if a player has or takes the ball in the opposition's penalty area OR immediately when a [Loose Ball](https://counterattackgame.github.io/wiki/es/loose_ball) hits an attacking player in the opposition's penalty area or outside the box within shooting distance.
...
Just before the snapshot is taken, 1 opponent is allowed to move any player 2 hexes in an attempt to deflect the shot (see [Loose Ball](https://counterattackgame.github.io/wiki/es/loose_ball)). This can include the [goalkeeper](https://counterattackgame.github.io/wiki/es/goalkeeper).
...
3. Attack calls the direction of the shot. Agree on which defenders can attempt to block. Resolve any block attempts. If the ball is blocked , play the [Loose Ball](https://counterattackgame.github.io/wiki/es/loose_ball). If not proceed below.
...
Following an aerial challenge, a [keeper](https://counterattackgame.github.io/wiki/es/goalkeeper) is still eligible to move 1 when the ball enters the box and also take advantage of the 2 moves following a snapshot declaration.
...
- Shot attempts (Snapshots, Shots and [Headed](https://counterattackgame.github.io/wiki/es/heading) attempts at Goal) travel in a STRAIGHT line.
